...
from app.search.client import DEFAULT_RANKING_RULES, ensure_index  # noqa: E402
from app.search.indexer import reindex_all  # noqa: E402
...
def main():
    ...
    parser.add_argument(
        "--skip-ranking", action="store_true", help="跳过 ranking rules 更新"
    )
