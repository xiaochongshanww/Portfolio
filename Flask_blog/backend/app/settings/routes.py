...
def get_system_info():
    ...
    try:
        ...
        return jsonify({"code": 0, "message": "ok", "data": system_info})
...
def generate_sitemap():
    ...
    try:
        ...
        for article in articles:
            sitemap_content.append("<url>")
            sitemap_content.append(
                f"  <loc>http://localhost:3000/article/{article.slug or article.id}</loc>"  # noqa: E501
            )
...
def create_backup():
    ...
    try:
        ...
        return jsonify({"code": 0, "message": "系统备份创建完成", "data": backup_info})
...
def get_backup_history():
    ...
    try:
        ...
        return jsonify({"code": 0, "message": "ok", "data": backup_history})
