    ...
    def track_visit():
        ...
        try:
            ...
            if visitor:
                ...
                logger.info(
                    f"Updating existing visitor record: original page views={visitor.page_views}"  # noqa: E501
                )
                ...
                is_new_visitor = True
                logger.info(
                    f"New visitor added to session: is_new_visitor={is_new_visitor}"
                )
    ...
    def get_today_stats():
        ...
        try:
            ...
            if daily_stat:
                ...
                return {"today_visitors": 0, "today_page_views": 0}
        except Exception as e:
        ...
        try:
            ...
            total_visitors = (
                db.session.query(
                    func.count(
                        func.distinct(
                            VisitorStats.ip_address + VisitorStats.user_agent_hash
                        )
                    )
                ).scalar()
                or 0
            ...
            # 计算总页面浏览量
            total_page_views = (
                db.session.query(func.sum(DailyStats.total_page_views)).scalar() or 0
            )
            ...
            return {"total_visitors": 0, "total_page_views": 0}
