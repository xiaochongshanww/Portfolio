...
MD_EXTENSIONS: list[str] = ["fenced_code", "codehilite", "tables", "toc"]
...
def _build_video_iframe(url: str) -> str:
    """Given a raw video page url, produce an embeddable iframe snippet (raw, will be sanitized)."""  # noqa: E501
    try:
        parsed = urlparse(url)
    ...
    return (
        ...
        'allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" '  # noqa: E501
...
def _preprocess_shortcodes(text: str) -> str:
    """Convert :::video <url>::: / :::gist <url>::: lines into HTML placeholders before markdown render."""  # noqa: E501
    out_lines: list[str] = []
...
def sanitize_html(raw_html: str | None) -> str:
    ...
    # Linkify AFTER cleaning (so we don't accidentally allow scripts). Then sanitize again lightly.  # noqa: E501
